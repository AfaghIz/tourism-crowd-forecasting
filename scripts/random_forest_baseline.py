...
OUTPUT_DIR = PROJECT_ROOT / "data" / "processed" / "random_forest_baseline"
...
def build_feature_importance_table(model: RandomForestRegressor, feature_names: list[str]) -> pd.DataFrame:
    return (
        pd.DataFrame(
            {
                "model": "Random Forest",
    ...
    predictions_df = pd.DataFrame(
        {
            ...
            "predicted_crowd_index_rf": full_pred,
